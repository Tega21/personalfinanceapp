...
public class SecurityConfig {
    ...
    /**
     * Returns a clean 401 Unauthorized JSON response for any request that
     * fails to authenticate (missing or invalid JWT), instead of Spring
     * Security's default behavior of returning 403 for anonymous requests.
     *
     * @return the entry point used whenever authentication is required but missing
     */
    @Bean
